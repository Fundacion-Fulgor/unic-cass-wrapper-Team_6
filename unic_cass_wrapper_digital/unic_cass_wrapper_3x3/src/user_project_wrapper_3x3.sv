...
module user_project_wrapper_3x3 (
    inout wire io_clock_PAD,
    inout wire io_reset_PAD,
    inout wire [34:0] ui_PAD,
    inout wire [34:0] uo_PAD
);
    wire io_clock_p2c;
    wire io_reset_p2c;
    wire [34:0] ui_PAD2CORE;
    wire [34:0] uo_CORE2PAD;
...
//
    ...
    generate
    for (genvar i=0; i<35; i++) begin : sg13g2_IOPadIn_ui
        sg13g2_IOPadIn ui (
            `ifdef USE_POWER_PINS
            .vss    (VSS),
            .vdd    (VDD),
    ...
    generate
    for (genvar i=0; i<35; i++) begin : sg13g2_IOPadOut30mA_uo
    ...
    assign uo_CORE2PAD[34:17] = ui_PAD2CORE[34:17];

    user_project_example user_project_example_inst (
        .clk_i  (io_clock_p2c),
        .rst_ni (io_reset_p2c),
        .ui_PAD2CORE (ui_PAD2CORE[16:0]),
        .uo_CORE2PAD (uo_CORE2PAD[16:0])
    );
